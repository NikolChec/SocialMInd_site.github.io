...
const translations = {
  en: {
    pilot_delivery_note: "This opens a draft in your email app addressed to socialmind2025@gmail.com. Review it and press Send there to send your request.",
    pilot_submit: "Open email draft",
    pilot_draft_status: "Your request has not been sent from this website. Finish sending it in your email app. If no draft opened, email socialmind2025@gmail.com directly; your details are still in the form.",
    pilot_blank_error: "Please enter more than spaces.",
    pilot_eyebrow: "LET'S GET TO KNOW YOU",
    pilot_title: "Bring SocialMind to your school.",
    pilot_intro: "Interested in a pilot? Tell us a little about yourself and where you're from so we can start a conversation.",
    pilot_direct: "Prefer to reach out directly?",
    pilot_form_title: "Book a pilot",
    pilot_required: "All fields are required.",
    pilot_name: "Full name",
    pilot_email: "Email address",
    pilot_email_hint: "Gmail or any other email address.",
    pilot_location: "Where are you from?",
    pilot_location_hint: "Your school or organization, city, and country.",
    pilot_message: "Tell us about yourself",
    pilot_message_hint: "What is your role, and what would you like to explore with SocialMind?",
  ...
  he: {
    pilot_delivery_note: "הטופס יפתח טיוטה באפליקציית האימייל שלכם אל socialmind2025@gmail.com. בדקו את הפרטים ולחצו שם על שליחה כדי לשלוח את הבקשה.",
    pilot_submit: "פתיחת טיוטת אימייל",
    pilot_draft_status: "הבקשה לא נשלחה מהאתר. יש להשלים את השליחה באפליקציית האימייל שלכם. אם לא נפתחה טיוטה, שלחו אימייל ישירות אל socialmind2025@gmail.com; הפרטים שלכם עדיין מופיעים בטופס.",
    pilot_blank_error: "יש להזין תוכן שאינו רק רווחים.",
    pilot_eyebrow: "נעים להכיר",
    pilot_title: "הביאו את SocialMind לבית הספר שלכם.",
    pilot_intro: "מתעניינים בפיילוט? ספרו לנו קצת על עצמכם ומאיפה אתם, כדי שנוכל להתחיל בשיחה.",
    pilot_direct: "מעדיפים לפנות ישירות?",
    pilot_form_title: "הזמנת פיילוט",
    pilot_required: "כל השדות הם שדות חובה.",
    pilot_name: "שם מלא",
    pilot_email: "כתובת אימייל",
    pilot_email_hint: "כתובת Gmail או כל כתובת אימייל אחרת.",
    pilot_location: "מאיפה אתם?",
    pilot_location_hint: "בית הספר או הארגון שלכם, העיר והמדינה.",
    pilot_message: "ספרו לנו על עצמכם",
    pilot_message_hint: "מה התפקיד שלכם, ומה הייתם רוצים לבדוק עם SocialMind?",
