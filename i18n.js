...
const translations = {
  en: {
    ...
    hero_eyebrow: "Real-time AI · Immersive VR · Social-emotional learning",
    hero_title_pre: "A calm place for teens to",
    hero_title_keyword: "practice",
    hero_title_mid: "the moments that feel",
    hero_title_emphasis: "hardest",
    hero_lead: "SocialMind pairs patient, real-time AI characters with safe, school-based VR scenes — so students can rehearse everyday social situations at their own pace, and walk away with a little more courage each time.",
    hero_cta_primary: "Book a school pilot",
    hero_cta_secondary: "Watch the demo",
    ...
    path2_text: "Collaborate on programs and research that help more teens feel they belong.",
    path2_cta: "Explore partnership",
    path3_k: "Investors",
    path3_title: "Back a mission with momentum",
    path3_text: "A focused team building real product in a growing youth-wellbeing market.",
  ...
  he: {
    ...
    hero_cta_secondary: "לצפייה בהדגמה",
    ...
    path2_text: "שתפו פעולה בתוכניות ומחקר שעוזרים ליותר בני נוער להרגיש שייכים.",
    path2_cta: "לבירור שותפות",
    path3_k: "משקיעים",
    path3_title: "גבו משימה עם תאוצה",
    path3_text: "צוות ממוקד שבונה מוצר אמיתי בשוק רווחת הנוער הצומח.",
